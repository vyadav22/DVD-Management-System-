      ...
      btnAddCustomer.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
        	 ...
        	 if (Pattern.matches(pattern, txtName.getText())) {
            	 ...
            	 String pattern2 = "[0-9]+";
            	 if (Pattern.matches(pattern2, tempNum)) {
            	     try {
            		 ...
            		 JOptionPane.showMessageDialog(null, "format of phone-number is number(0-9)");

            	 }

        	 } else {

        		 JOptionPane.showMessageDialog(null, "format of name is character ( number is invalid) ");
        	 }
