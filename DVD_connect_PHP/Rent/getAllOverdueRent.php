...
$min=100*($number-1);
  ...
  $sql="select r.R_id, r.d_id, r.c_id, d.title, r.start_date, r.due_date, r.overdue from Rent r, DVD d where r.d_id=d.d_id and overdue=1 limit $min,100;";
...
$xmlcode .= "<c_id>$c_id</c_id>\n";
 ...
 $xmlcode .="</DVD>\n";
 $filename ="xmlFromPHP/getAllOverdueRent.xml"; //파일 이름
