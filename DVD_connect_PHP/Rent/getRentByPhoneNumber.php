...
$min=100*($number-1);
 ...
 $sql="select r.R_id, r.d_id, r.c_id, d.title, r.start_date, r.due_date, r.overdue from Rent r, DVD d where r.c_id=(select c.c_id from Customer c where c.phoneNum='$phoneNum') and r.d_id=d.d_id limit $min,100;;"
...
$xmlcode .= "<c_id>$c_id</c_id>\n";
 ...
 $xmlcode .="</DVD>\n";
 $filename ="xmlFromPHP/getRentByPhoneNumber.xml"; //파일 이름
